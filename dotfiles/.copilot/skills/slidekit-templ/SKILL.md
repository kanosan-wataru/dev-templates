...
```bash
python ~/.copilot/skills/slidekit-templ/scripts/pdf_to_images.py input.pdf output_dir
```
...
1. `~/.copilot/skills/slidekit-create/SKILL.md` — Mandatory constraints, PPTX conversion rules, anti-patterns, design guidelines, HTML boilerplate, pre-delivery checklist
2. `~/.copilot/skills/slidekit-create/references/patterns.md` — 15 layout patterns with DOM trees, component snippets
